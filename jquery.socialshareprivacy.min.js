 ...
 * Edit By "Socialshareplugin"-Wordpress Plugin #01
 *
...
txt_gplus_off:"nicht mit Google+ verbunden",txt_plus_on:"mit Google+ verbunden",perma_option:"on",display_name:"Google+",referrer_track:"",language:"de"}},info_link:"http://www.heise.de/ct/artikel/2-Klicks-fuer-mehr-Datenschutz-1333879.html",txt_help:"Wenn Sie diese Felder durch einen Klick aktivieren, werden Informationen an Facebook, Twitter oder Google in die USA &uuml;bertragen und unter Umst&auml;nden auch dort gespeichert. N&auml;heres erfahren Sie durch einen Klick auf das <em>i</em>.",settings_perma:"Dauerhaft aktivieren und Daten&uuml;ber&shy;tragung zustimmen:",
cookie_path:"/",cookie_domain:document.location.host,cookie_expires:"365",css_path:"socialshareprivacy/socialshareprivacy.css",css_layout:""},a);if(a.services.facebook.status=="on"&&a.services.facebook.app_id!="__FB_APP-ID__"||a.services.twitter.status=="on"||a.services.gplusone.status=="on"){b("head").append('<link rel="stylesheet" type="text/css" href="'+a.css_path+'" />');b(this).prepend('<ul class="social_share_privacy_area '+a.css_layout+'"></ul>');var c=b(".social_share_privacy_area",this),m=document.location.href,i=b('link[rel="canonical"]').attr("href");
i&&i.length>0&&(i.indexOf("http")<0&&(i=document.location.protocol+"//"+document.location.host+i),m=i)}return this.each(function(){if(a.services.facebook.status=="on")if(a.services.facebook.app_id!="__FB_APP-ID__"){var e=encodeURIComponent(m+a.services.facebook.referrer_track),i='<iframe src="http://www.facebook.com/plugins/like.php?locale='+a.services.facebook.language+"&amp;app_id="+a.services.facebook.app_id+"&amp;href="+e+'&amp;send=false&amp;layout=button_count&amp;width=120&amp;show_faces=false&amp;action=recommend&amp;colorscheme=light&amp;font&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden;" allowTransparency="true"></iframe>',
l='<img src="'+a.services.facebook.dummy_img+'" alt="Facebook &quot;Like&quot;-Dummy" class="fb_like_privacy_dummy" />';c.append('<li class="facebook help_info '+a.css_layout+'"><span class="info">'+a.services.facebook.txt_info+'</span><span class="switch off">'+a.services.facebook.txt_fb_off+'</span><div class="fb_like dummy_btn">'+l+"</div></li>");var g=b("li.facebook",c);b("li.facebook div.fb_like img.fb_like_privacy_dummy,li.facebook span.switch",c).live("click",function(){g.find("span.switch").hasClass("off")?
